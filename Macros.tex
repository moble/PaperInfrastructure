...
\chardef\omicron=111 % For insurance against upcasing
\chardef\Omicron=79  % For insurance against downcasing
...
\newcommand\MakeAllUppercase[1]{%
  % Include eth, thorn, and Greek in MakeUppercase
  \begingroup
  \let\eth\Eth
  \let\thorn\Thorn
  \let\alpha\Alpha
