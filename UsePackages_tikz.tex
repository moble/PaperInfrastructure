...
\tikzset{
  every picture/.style={font issue=\fontsize{9}{10.5}},
...
\makeatletter
\input{tikz-colorbrewer/tikzlibrarycolorbrewer.code.tex}
\input{tikz-colorbrewer/pgflibrarypgfplots.colorbrewer.code.tex}
\makeatother
